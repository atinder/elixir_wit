defmodule Wit.Models.Response.Converse do
  ...
  @type t :: %{type: String.t, msg: String.t, action: any, entities: [map()], quickreplies: [map()], confidence: float}
  defstruct type: "", msg: nil, action: nil, entities: [], quickreplies: [], confidence: 0
end
...
defmodule Wit.Models.Response.Outcome do
  ...
  @type t :: %{_text: String.t, intent: String.t, entities: [map()], quickreplies: [map()], confidence: float}
  defstruct _text: "", intent: "", entities: [], quickreplies: [], confidence: 0
end
